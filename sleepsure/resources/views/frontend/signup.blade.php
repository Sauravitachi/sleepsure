                    ...
                    <div class="account-panel">
                        <div class="brand-section">
                            <div class="brand-logo" style="margin: 60px auto;">
                                <img src="assets/images/logo.png" alt="Home Icon" class="home-icon">
                            </div>
                        ...
                        <div class="form-section">
                            ...
                            <form id="accountForm">
                                <div class="input-row">
                                    <div class="input-half">
                                        <div class="field-group">
                                            ...
                                            <input type="text" class="field-input" id="userFirstName" placeholder="Enter first name" required>
                                        </div>
                                    </div>
                                    <div class="input-half">
                                        <div class="field-group">
                                            <label for="userLastName" class="field-label">Last Name</label>
                                            <input type="text" class="field-input" id="userLastName" placeholder="Enter last name" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="email" class="field-input" id="userEmail" placeholder="Enter your email" required>
                                </div>

                                <div class="field-group">
                                    <label for="userPhone" class="field-label">Mobile Number</label>
                                    <input type="tel" class="field-input" id="userPhone" placeholder="Enter your mobile number" required>
                                </div>
