                ...
                <div class="card-bottom">
                    <div class="card-info">
                        ...
                        <div class="item-price">
                            ...
                            @if(!empty($product->original_price) && (float)$product->original_price > (float)($product->price_value ?? 0))
                                <span class="old-price">{{ $product->original_price }}</span>
                                <span class="sale-badge">{{ round(((float)$product->original_price - (float)$product->price_value) / (float)$product->original_price * 100) }}% off</span>
                            @endif
                        </div>
                    </div>
